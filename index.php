...
<?php $merchant_id = "4255562" ?>
    ...
    <br>
    <tr class="hidden">
    <td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="http://127.0.0.1/ccavenupayment/ccavResponseHandler.php"/></td>
    </tr>
    <tr class="hidden">
    <td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="http://127.0.0.1/ccavenupayment/ccavResponseHandler1.php"/></td>
    </tr>
    <tr class="hidden">
